// Ejecuta después de que el DOM y el menú hayan cargado (por fetch)
document.addEventListener('DOMContentLoaded', function() {
  // Intenta detectar los botones varias veces por si el fetch es lento
  let intentos = 0;
  function iniciarAccesibilidad() {
    ...
    if (!ajustesBtn || !accesibilidadMenu) {
      intentos++;
      if (intentos < 20) setTimeout(iniciarAccesibilidad, 150);
      return;
    }
